 ...
 * @author Madina
 */
public class msoption extends javax.swing.JFrame {

    /**
     * Creates new form msoption
     */
    public msoption() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\mariumyounus\\Desktop\\Gym\\Gym\\src\\gym\\Images\\moption.PNG")); // NOI18N
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(170, 90, 1000, 480);

        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(260, 50, 34, 14);

        msback.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gym/Images/Background.jpg"))); // NOI18N
        getContentPane().add(msback);
        msback.setBounds(0, 0, 1370, 700);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(msoption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel msback;
