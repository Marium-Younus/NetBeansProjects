...
public class Tview extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tratable = new javax.swing.JTable();
        ...
        jLabel2.setText("Transaction View");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(540, 20, 360, 50);
        ...
        jButton1.setBounds(600, 600, 170, 30);

        jScrollPane1.setViewportView(tratable);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(350, 80, 660, 510);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String p_type=res.getString(2);
        String p_date=res.getString(3);
      ...
      tratable.setModel(new DefaultTableModel(data,header));
    ...
    private javax.swing.JTable tratable;
