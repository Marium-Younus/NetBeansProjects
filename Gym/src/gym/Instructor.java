...
public class Instructor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(730, 640));
        getContentPane().setLayout(null);

        jLabel1.setFont(new java.awt.Font("Comic Sans MS", 0, 36)); // NOI18N
        jLabel1.setText("Instructor Information :");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(150, 10, 430, 40);

        jLabel2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel2.setText("Instructors");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(120, 70, 180, 30);

        jLabel3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel3.setText("First Name");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(120, 120, 180, 30);

        jLabel4.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel4.setText("Last Name");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(120, 170, 180, 30);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel5.setText("Contact No");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(120, 220, 170, 30);

        jLabel6.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel6.setText("Address");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(120, 300, 170, 30);

        jLabel7.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel7.setText("Date Of Joining");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(120, 400, 170, 30);

        jLabel8.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel8.setText("Schedule");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(120, 450, 180, 30);
        getContentPane().add(jTextField1);
        jTextField1.setBounds(320, 120, 170, 30);
        getContentPane().add(jTextField2);
        jTextField2.setBounds(320, 170, 170, 30);
        getContentPane().add(jTextField3);
        jTextField3.setBounds(320, 220, 170, 30);
        getContentPane().add(jTextField4);
        jTextField4.setBounds(320, 500, 190, 30);
        ...
        jScrollPane1.setBounds(320, 270, 180, 96);

        getContentPane().add(jComboBox1);
        jComboBox1.setBounds(320, 450, 180, 30);

        getContentPane().add(jComboBox2);
        jComboBox2.setBounds(320, 400, 180, 30);

        jLabel9.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel9.setText("Sallary");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(120, 500, 180, 30);

        getContentPane().add(jComboBox3);
        jComboBox3.setBounds(320, 70, 170, 30);

        img.setIcon(new javax.swing.ImageIcon("D:\\Pictures\\Dp\\2715.jpg")); // NOI18N
        img.setText("Image");
        getContentPane().add(img);
        img.setBounds(510, 70, 170, 170);

        jButton1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jButton1.setText("ADD");
        getContentPane().add(jButton1);
        jButton1.setBounds(190, 540, 90, 30);

        jButton2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jButton2.setText("Update");
        getContentPane().add(jButton2);
        jButton2.setBounds(290, 540, 90, 30);

        jButton3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jButton3.setText("Delete");
        getContentPane().add(jButton3);
        jButton3.setBounds(390, 540, 90, 30);
        getContentPane().add(instrback);
        instrback.setBounds(0, 0, 730, 580);
