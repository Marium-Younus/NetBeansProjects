...
public class plancourse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(190, 200, 130, 30);

        jLabel3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel3.setText("  Amount");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(190, 250, 130, 30);
        getContentPane().add(ptype);
        ptype.setBounds(350, 200, 200, 30);
        getContentPane().add(amount);
        amount.setBounds(350, 250, 200, 30);

        jButton1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jButton1.setText("Go");
        getContentPane().add(jButton1);
        jButton1.setBounds(280, 310, 120, 30);
        getContentPane().add(jLabel1);
        jLabel1.setBounds(130, 160, 450, 250);
        getContentPane().add(backp);
        backp.setBounds(0, 0, 720, 570);
